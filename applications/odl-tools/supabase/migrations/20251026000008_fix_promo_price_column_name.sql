-- ============================================================================
-- Migration: Fix promo_price column name in validate function
-- Date: 2025-10-26
-- Description: Column is named promo_price, not promo_price_ttc
-- ============================================================================
...
BEGIN
  ...
  INSERT INTO offer_item_calculated_costs (
    ...
    msrp,
    street_price,
    promo_price,  -- FIXED: was promo_price_ttc
    purchase_price_ht,
    purchase_currency,
    currency_rate,
  ...
  RETURN jsonb_build_object(
    ...
    'pricing', jsonb_build_object(
      ...
      'promo_price', v_promo_price,  -- FIXED: was promo_price_ttc
...
COMMENT ON FUNCTION validate_and_calculate_item IS 'Validates supplier item offer with hierarchical rules and configurable deal thresholds. Fixed: promo_price column name.';

-- Success message
DO $$
BEGIN
  RAISE NOTICE '✓ Function validate_and_calculate_item() updated - fixed promo_price column name';
END $$;
