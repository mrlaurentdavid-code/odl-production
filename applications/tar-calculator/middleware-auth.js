/**
 * Middleware d'authentification et de contrôle d'accès pour TAR Calculator
 * Vérifie que l'utilisateur est authentifié ET a accès à l'app tar-calculator
 */
...
/**
 * Middleware pour vérifier l'accès à l'application tar-calculator
 */
