-- Migration: Create customer transport optimization tool
-- Description: Calculate optimal shipping quantities (1-10) to minimize unit cost
...
BEGIN
    ...
    FOR v_quantity IN 1..10 LOOP
        ...
        LOOP
            ...
            -- Pour maximiser le nombre de produits, on doit essayer:
            ...
            IF v_container.c_total < v_best_cost THEN
                ...
                -- Ne pas EXIT ici! On doit vérifier tous les conteneurs pour trouver le moins cher
            END IF;
        END LOOP;
        ...
        IF v_best_container IS NOT NULL THEN
            ...
            -- Tester toutes les orientations possibles
            DECLARE
                v_orientation_capacity INT;
                v_orientation_per_layer INT;
                v_orientation_max_layers INT;
