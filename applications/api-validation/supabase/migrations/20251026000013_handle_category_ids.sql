-- Migration: Handle category_id and subcategory_id from WeWeb
-- Date: 2025-10-26
-- Purpose: Accept category_id/subcategory_id and lookup names from tables
...
DECLARE
  ...
  v_category_id TEXT; -- NEW: Accept category_id
  v_subcategory_id TEXT; -- NEW: Accept subcategory_id
  v_msrp NUMERIC;
...
BEGIN
  ...
  v_category_id := p_item_data->>'category_id'; -- NEW
  v_subcategory_id := p_item_data->>'subcategory_id'; -- NEW
  ...
  -- NEW: Lookup category/subcategory names from IDs if provided
...
'Validates supplier item offer. Accepts category_id/subcategory_id and looks up names. Auto-generates UUID for item_id when NULL. Returns generated_item_id in response.';
