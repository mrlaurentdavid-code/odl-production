-- ============================================================================
-- Migration: Remove sensitive data from API response
-- Date: 2025-10-26
-- Description: Remove costs_breakdown and deal_thresholds from supplier API response
--              These are internal O!Deal business data that should not be exposed
-- ============================================================================
...
BEGIN
  ...
  -- ============================================================================
  -- STEP 9: RETURN SUCCESS RESPONSE (without sensitive data)
  -- ============================================================================
  ...
  RETURN jsonb_build_object(
    ...
    -- REMOVED: costs_breakdown (internal O!Deal costs - SENSITIVE)
    -- REMOVED: deal_thresholds (internal O!Deal business rules - SENSITIVE)
  );
...
COMMENT ON FUNCTION validate_and_calculate_item IS 'Validates supplier item offer. Removed sensitive internal data from response.';

DO $$
BEGIN
  RAISE NOTICE '✓ Function validate_and_calculate_item() updated - removed costs_breakdown and deal_thresholds from API response';
END $$;
